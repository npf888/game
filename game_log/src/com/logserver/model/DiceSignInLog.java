...
public class DiceSignInLog extends BaseLogMessage{
       private int bet;
       private String roomNum;
       private String diceValues;
       private String diceName;
    
    public DiceSignInLog() {    	
    }
    ...
    public DiceSignInLog(
        ...
        super(MessageType.LOG_DICESIGNIN_RECORD,logTime,regionId,serverId,accountId,accountName,level,reason,param);
            this.bet =  bet;
    ...
    public short getType() {
        return MessageType.LOG_DICESIGNIN_RECORD;
    }

    @Override
    public String getTypeName() {
        return "LOG_DICESIGNIN_RECORD";
    }
}