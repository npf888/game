...
public class DiceShowHandLog extends BaseLogMessage{
       private int bet;
       private String roomNum;
       private String diceValues;
       private String diceName;
    
    public DiceShowHandLog() {    	
    }
    ...
    public DiceShowHandLog(
        ...
        super(MessageType.LOG_DICESHOWHAND_RECORD,logTime,regionId,serverId,accountId,accountName,level,reason,param);
            this.bet =  bet;
    ...
    public short getType() {
        return MessageType.LOG_DICESHOWHAND_RECORD;
    }

    @Override
    public String getTypeName() {
        return "LOG_DICESHOWHAND_RECORD";
    }
}