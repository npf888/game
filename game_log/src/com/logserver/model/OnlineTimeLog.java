...
public class OnlineTimeLog extends BaseLogMessage{
    ...
    public OnlineTimeLog(
                   long logTime,                   int regionId,                   int serverId,                   long accountId,                   String accountName,                   long level,                   int reason,                   String param,			int minute,			int totalMinute,			long lastLoginTime,			long lastLogoutTime            ) {
        super(MessageType.LOG_ONLINETIME_RECORD,logTime,regionId,serverId,accountId,accountName,level,reason,param);
            this.minute =  minute;
