...
public abstract class LoginedTelnetCommand extends AbstractTelnetCommand 
{
	...
	@Override
	public final void exec(String command, Map<String, String> params,IoSession session)
	{
		if (session.getAttachment() == null)
		{
			...
			{
				logger.warn("The gm command received from  from ["+ session.getRemoteAddress()+ "] has not logined,clost it.");
			}
			return;
		}
