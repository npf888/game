 ...
 * @author Thinker
 */
public abstract class AbstractTelnetCommand
{
	/** Telnet命令名称 */
	 ...
	 *            Telnet命令名称,非空
	 */
	public AbstractTelnetCommand(String commandName)
	{
	...
	{
		String _jsonParam = command.substring(this.getCommandName().length()).trim();
		return _jsonParam;
	}
}
