...
public class SingleThreadModel implements ThreadModel 
{
	...
	{
		filter = new ExecutorFilter(new ThreadPoolExecutor(1, 1, 60,TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>()));
		...
		ThreadFactory singleThreadFactory = new ThreadFactory()
		{
			...
			{
				Thread t = originalThreadFactory.newThread(new NamePreservingRunnable(runnable,"SingleIoService"));
				t.setDaemon(true);
				return t;
			}
		};
