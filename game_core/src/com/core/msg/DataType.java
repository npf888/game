...
public class DataType
{
	...
	public static BaseEntityMsg buildEntityMessage(final short entityType) 
	{
		...
		if (_type != null)
		{
			return _type.creator.creageEntityMessage();
		}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static void writeObjectData(final Object data,final ByteBuffer buffer)
	{
		if (data == null) 
		{
			buffer.put(NullType);
		...
		} else if (BaseEntity.class.isAssignableFrom(_dataClass)) 
		{
			...
			if (_entityType != null) 
			{
				...
				BaseEntityMsg _msg = _entityType.creator.creageEntityMessage();
			...
			{
				throw new IllegalStateException("Unknown entity type:"+ _dataClass);
			}
		} else 
		{
	 ...
	 */
	public static void writeRawTypeData(final Object data,final ByteBuffer buffer)
	{
		final Class<?> _dataClass = data.getClass();
	...
	public static Object readRawTypeData(final ByteBuffer buffer) 
	{
		...
		switch (_dataType)
		{
			...
			default:
				throw new IllegalArgumentException("Unsupport data type:"+ _dataType);
		}
	}
	 ...
	 *                在编码过程中出现错误会抛出此异常
	 */
	public static void writeString(String str, String charset,final ByteBuffer buffer)
	{
		try
		{
			if (str == null)
