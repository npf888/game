...
public class BaseVersionCheck<E extends Config> implements ICheck
{
	...
	protected void logVersionCheck(String version1Name, String version1Value, String version2Name,String version2Value, boolean match)
	{
		if (logger != null && logger.isInfoEnabled())
		{
			logger.info("[#WS.VersionCheck.logVersionCheck] [" + version1Name + ":" + version1Value + ","+ version2Name + ":" + version2Value + ",match:" + (match ? "Yes" : "No") + "]");
		}
	}
}
