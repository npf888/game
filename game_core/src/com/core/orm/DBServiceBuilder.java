...
public class DBServiceBuilder
{
	...
	public static DBService buildDirectDBService(IEventListener eventListener,int daoType, URL configUrl, String... resourceNames) 
	{
		// 使用Hibernate
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static DBService buildH2CacheService(IEventListener eventListener,int daoType, URL configUrl, String... resourceNames) 
	{
		// 使用Hibernate
		DBService _dbService = null;
		if (daoType == DBServiceConstants.DB_TYPE_HIBERNATE)
