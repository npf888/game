...
public class JSScriptManagerImpl implements IScriptEngine
{
	...
	public Object runScript(Map<String, Object> binding, String scriptFile, String charset) {
		...
		try {
			...
			throw new RuntimeException(ErrorsUtil.error(com.common.constants.CommonErrorLogInfo.FILE_IO_FAIL, "Throw Exception",
					scriptFile), e);
		} catch (ScriptException se) {
			throw new RuntimeException(ErrorsUtil.error(com.common.constants.CommonErrorLogInfo.SCRITP_EXECUTE_FAIL,
