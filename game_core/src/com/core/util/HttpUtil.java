...
public class HttpUtil
{
	...
	/** 连接超时,默认5秒 */
	private static final int DEFAULT_CONNECT_TIMEOUT = 15000000;
	/** 读取超时,默认5秒 */
	private static final int DEFAULT_READ_TIMEOUT = 15000000;
	/** 连接local的参数编码 */
...
//			// 调用接口处理成功采集
//			PIProbeCollector.collect(ProbeName.RPC, ProcessResult.SUCCESS,
//					(System.nanoTime() - _begin) / 1000000);
			return temp.toString();
		} catch (IOException e)
		{
//			// 调用接口处理失败采集
//			PIProbeCollector.collect(ProbeName.RPC, ProcessResult.FAIL, (System
//					.nanoTime() - _begin) / 1000000);
			throw e;
		} finally 
		{
			try 
	 ...
	 * @throws IOException
	 */
	public static List<String> getUrlAmazon(String requestUrl) throws IOException{
	...
	public static String postUrl(String requestUrl,String contentData) throws IOException 
	{
	 ...
	 * @throws IOException
	 */
	public static String getUrlUNencode(String requestParmUrl, Object... params)throws IOException
	{
		return getUrl(requestParmUrl);
	}
