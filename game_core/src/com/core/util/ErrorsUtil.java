...
public class ErrorsUtil
{
	 ...
	 * @return
	 */
	public static String errorAllThrowableStackMessage(String errorCode, Throwable throwable)
	{
		StringBuffer errorString = new StringBuffer();
		errorString.append("[" + errorCode + "] ");
		if (throwable != null)
		{
			errorString.append("Message=[" + throwable.getMessage() + "], ");
			errorString.append("Stacks={");
