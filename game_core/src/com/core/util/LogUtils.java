...
{
	/** 统一日志模板 */
	private static final String LOG_TEMPLATE = "[player=%d]%s";
	 ...
	 * @return
	 */
	public static String buildLogInfoStr(long roleUUID, String logInfo)
	{
	...
	public static boolean changeLogLevel(String logName, String level)
	{
		...
		if (_loggerFactory instanceof Log4jLoggerFactory) 
		{
			try
			{
				...
				org.apache.log4j.Logger _log4jLogger = (org.apache.log4j.Logger) RefUtil.getFieldValue(_logger,"logger");
