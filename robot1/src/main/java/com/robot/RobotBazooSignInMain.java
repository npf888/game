...
//import com.robot.strategy.impl.BazooSignInStrategy;
//
///**
// * 无双吹牛
// * @author JavaServer
// *
// */
//public class RobotBazooSignInMain {
//
//	
...
//			robNames.add("Robot5_289635521");
////			robNames.add("fadd32bf876be36981031f63cb0f9b32");
////			robNames.add("Robot5_72574691");
...
//			Robot robot =  createRobot(robName, serverId);
//			robot.getTimeTask().timeSeting(robot);
//			BazooSignInStrategy bt = new BazooSignInStrategy(robot);
//		
...
//	{
//		return new Robot(deviceMac,serverId,null);
//	}
//
//}
