...
//			robNames.add("Robot1_289635521");
//			robNames.add("Robot1_72574691");
//			robNames.add("Robot1_65343905");
//			robNames.add("Robot1_852249218");
//			robNames.add("Robot1_849512650");
//			robNames.add("Robot1_557901668");
//			robNames.add("Robot1_334248215");
//			robNames.add("Robot1_504599183");
			robNames.add("Robot1_840628281");
//			robNames.add("Robot1_173800878");
//			robNames.add("Robot1_173800899");
...
//							Robot = completeTest(name,port,serverId, path,dbService,templateService);
							Robot = completeTest(name,port,serverId, path);
...
//	private static Robot completeTest(String robName,int port,String serverId, String path,DBService dbService,TemplateService templateService) throws LocalException 
	private static Robot completeTest(String robName,int port,String serverId, String path) throws LocalException 
	{
...
//			robot.setTemplateService(templateService);
			...
			Robot robot =  createRobot(robName, serverId,null);
