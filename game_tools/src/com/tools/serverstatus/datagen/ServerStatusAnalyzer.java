...
public class ServerStatusAnalyzer
{
	...
	public void filtData(Map<String, List<StatusInfo>> statusInfos)
	{
		...
		try
		{
			...
			_reader = new BufferedReader(new InputStreamReader(new FileInputStream(logFile)));
			...
			while ((_line = _reader.readLine()) != null)
			{
				...
				List<StatusInfo> _statusInfoList = statusInfos.get(_status.getServerID());
	 ...
	 * @param statusInfo
	 */
	private void insertIntoList(List<StatusInfo> statusList,StatusInfo statusInfo) 
	{
