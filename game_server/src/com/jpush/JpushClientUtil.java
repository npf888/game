...
public class JpushClientUtil {
    ...
    private final static String appKey = "f9357e45f610a9da96fbfbaf";
 
    private final static String masterSecret = "4e6c3cfd69eeb7e3fc69ee95";
 
    private static JPushClient jPushClient = new JPushClient(masterSecret,appKey);;
 
    public static void main(String[] args) {
//    	JPushClient jPushClient = new JPushClient(masterSecret,appKey);
    	sendToAllAndroid("啦啦啦", "123", "aaaaaaaa", "");
	}
    /**
     * 推送给设备别名的用户
     ...
     * @return 0推送失败，1推送成功
     */
    public static int sendToAlias( String alias,String notification_title, String msg_title, String msg_content, String extrasparam, boolean isNotification, boolean isMessage) {
        int result = 0;
        try {
            PushPayload pushPayload= JpushClientUtil.buildPushObject_all_Alias_alertWithTitle(alias,notification_title,msg_title,msg_content,extrasparam, isNotification, isMessage);
            Loggers.PUSH.info(pushPayload.toString());
            PushResult pushResult=jPushClient.sendPush(pushPayload);
            Loggers.PUSH.info(pushResult.toString());
            if(pushResult.getResponseCode()==200){
                result=1;
            }
        } catch (APIConnectionException e) {
        	Loggers.PUSH.error("", e);
    ...
    public static PushPayload buildPushObject_android_and_ios(String notification_title, String msg_title, String msg_content, String extrasparam) {
        return PushPayload.newBuilder()
                ...
                .setMessage(Message.newBuilder()
                        ...
                        .setTitle(msg_title)
                        .addExtra("message extras key",extrasparam==null?"":extrasparam)
                        .build())
    ...
    private static PushPayload buildPushObject_all_Alias_alertWithTitle(String alias,String notification_title, String msg_title, String msg_content, String extrasparam, boolean isNotification, boolean isMessage) {
    	 
    	Loggers.PUSH.info("----------buildPushObject_all_all_alert");
...
//                        .setSendno(1)
    ...
    private static PushPayload buildPushObject_android_all_alertWithTitle(String notification_title, String msg_title, String msg_content, String extrasparam) {
    	Loggers.PUSH.info("----------buildPushObject_android_registrationId_alertWithTitle");
        return PushPayload.newBuilder()
                //指定要推送的平台，all代表当前应用配置了的所有平台，也可以传android等具体平台
    ...
    private static PushPayload buildPushObject_ios_all_alertWithTitle( String notification_title, String msg_title, String msg_content, String extrasparam) {
    	Loggers.PUSH.info("----------buildPushObject_ios_registrationId_alertWithTitle");
        return PushPayload.newBuilder()
                //指定要推送的平台，all代表当前应用配置了的所有平台，也可以传android等具体平台
