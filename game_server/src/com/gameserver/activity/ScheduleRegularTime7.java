 ...
 *
 */
public class ScheduleRegularTime7  implements LLISchedule{
	...
	private Human ower;
	public ScheduleRegularTime7(String regularTime,String now,int packCycleTime,int packDurationTime,Human ower){
