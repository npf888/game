 ...
 */
public class GCSlotType29WildInfo extends GCMessage{
	...
	public short getType() {
		return MessageType.GC_SLOT_TYPE29_WILD_INFO;
	}
	
	@Override
	public String getTypeName() {
		return "GC_SLOT_TYPE29_WILD_INFO";
	}
