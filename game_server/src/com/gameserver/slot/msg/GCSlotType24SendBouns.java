 ...
 */
public class GCSlotType24SendBouns extends GCMessage{
	...
	public short getType() {
		return MessageType.GC_SLOT_TYPE24_SEND_BOUNS;
	}
	
	@Override
	public String getTypeName() {
		return "GC_SLOT_TYPE24_SEND_BOUNS";
	}
