 ...
 */
public class GCSlotType31WildInfo extends GCMessage{
	...
	public short getType() {
		return MessageType.GC_SLOT_TYPE31_WILD_INFO;
	}
	
	@Override
	public String getTypeName() {
		return "GC_SLOT_TYPE31_WILD_INFO";
	}
