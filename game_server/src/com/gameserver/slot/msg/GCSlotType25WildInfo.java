 ...
 */
public class GCSlotType25WildInfo extends GCMessage{
	...
	public short getType() {
		return MessageType.GC_SLOT_TYPE25_WILD_INFO;
	}
	
	@Override
	public String getTypeName() {
		return "GC_SLOT_TYPE25_WILD_INFO";
	}
