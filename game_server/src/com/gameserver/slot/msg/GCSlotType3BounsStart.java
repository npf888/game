 ...
 */
public class GCSlotType3BounsStart extends GCMessage{
	
	/** 当前的金币 */
	private long[] currentGold;

	public GCSlotType3BounsStart (){
	}
	...
	public short getType() {
		return MessageType.GC_SLOT_TYPE3_BOUNS_START;
	}
	
	@Override
	public String getTypeName() {
		return "GC_SLOT_TYPE3_BOUNS_START";
	}
