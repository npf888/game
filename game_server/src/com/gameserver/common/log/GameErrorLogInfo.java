...
///////////////////////需要使用的从下面拷贝到上面。下面不需要最后统一删除////////////////////
	...
	/**生成值冲订单*/
	public static final String CREATE_IOS_PAYMENT_ERROR="CREATE.IOS.PAYMENT.ERROR";
	/**直充接口*/
	public static final String EXPEND_IOS_PAYMENT_ERROR="EXPEND.IOS.PAYMENT.ERROR";
	/**判断完家是否黑名单用户*/
	public static final String IS_BLACK_LIST_USER_ERROR="IS.BLACK.LIST.USER.ERROR";
	...
	/***充值相关异常*/
	//首充钻石奖异常
	public static final String CHARGE_FIRST_REWARD_FAIL = "CHARGE.FIRST.REWARD.INVOKEFAIL";
	
	/* 任务引导相关的错误定义 */
	/** 任务引导不存在 */
	public static final String TASKGUIDE_NO_EXIST = "TASKGUIDE.ERR.NO.EXIST";
	/** 重复的任务引导 */
	public static final String TASKGUIDE_DUP = "TASKGUIDE.ERR.DUP";
}
