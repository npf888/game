 ...
 */
public class GCBlackWhiteEndCount extends GCMessage{
	
	/** 结算返回 每个人的信息 */
	private com.gameserver.bazoo.data.EndCountInfo[] endCountInfo;

	public GCBlackWhiteEndCount (){
	}
	...
	public short getType() {
		return MessageType.GC_BLACK_WHITE_END_COUNT;
	}
	
	@Override
	public String getTypeName() {
		return "GC_BLACK_WHITE_END_COUNT";
	}
