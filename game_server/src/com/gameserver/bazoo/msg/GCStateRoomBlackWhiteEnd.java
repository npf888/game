 ...
 */
public class GCStateRoomBlackWhiteEnd extends GCMessage{
	
	/** 结算返回 每个人的信息 */
	private com.gameserver.bazoo.data.EndCountInfo[] endCountInfo;

	public GCStateRoomBlackWhiteEnd (){
	}
	...
	public short getType() {
		return MessageType.GC_STATE_ROOM_BLACK_WHITE_END;
	}
	
	@Override
	public String getTypeName() {
		return "GC_STATE_ROOM_BLACK_WHITE_END";
	}
