 ...
 */
public class GCStateRoomShowHandRoundResult extends GCMessage{
	...
	public GCStateRoomShowHandRoundResult (){
	}
	...
	public short getType() {
		return MessageType.GC_STATE_ROOM_SHOW_HAND_ROUND_RESULT;
	}
	
	@Override
	public String getTypeName() {
		return "GC_STATE_ROOM_SHOW_HAND_ROUND_RESULT";
	}
