 ...
 * 
 */
public class RoleBaseLongProperties extends GenericPropertyObject<Long>
{
	/** 基础整型属性索引开始值 */
	...
	public RoleBaseLongProperties() 
	{
		super(Long.class, _SIZE, TYPE);
